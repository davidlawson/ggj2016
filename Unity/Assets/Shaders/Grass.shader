    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float node_6428_if_leA = step(i.posWorld.g,_WorldClip);
                float node_6428_if_leB = step(_WorldClip,i.posWorld.g);
                float node_3602 = 1.0;
                clip(lerp((node_6428_if_leA*node_3602)+(node_6428_if_leB*0.0),node_3602,node_6428_if_leA*node_6428_if_leB) - 0.5);
////// Lighting:
////// Emissive:
