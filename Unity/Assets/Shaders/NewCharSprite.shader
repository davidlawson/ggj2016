...
////// Emissive:
                ...
                float4 node_6643 = _Time + _TimeEditor;
                float2 node_2309 = ((i.screenPos.rg*0.5+0.5)+(float2(_XSpeedVert,_YSpeedVert)*node_6643.g));
                float4 _RealTex_var = tex2D(_RealTex,TRANSFORM_TEX(node_2309, _RealTex));
